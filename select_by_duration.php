        ...
        <table class="table">
            ...
            <tbody>
                ...
                <?php 
                    ...
                    {
                        if(!empty($_POST['duration_min']) && !empty($_POST['duration_max'])){
                            
                            //echo $_POST['duration_min'] . " " . $_POST['duration_max'] . "<br>";
                            $min = $_POST['duration_min'];
                            $max = $_POST['duration_max'];
                            
                            
                            $sql_statement = "SELECT * FROM movies_table WHERE duration BETWEEN $min AND $max"; 
