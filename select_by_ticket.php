        ...
        <table class="table">
            ...
            <?php 
                ...
                if(isset($_POST['save_ticket']))
                {
                    ...
                    if(!empty($_POST['tickets1']) && !empty($_POST['tickets2'])){
                        
                        
                        $min = (int)$_POST['tickets1'];
                        $max = (int)$_POST['tickets2'];
                        //echo "Range from " . $min . " to " . $max . "<br>";
                        
                        $sql_statement = "SELECT * FROM movies_table WHERE tickets_sold BETWEEN $min AND $max"; 
